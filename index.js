const generateTickets = (tickets) => {
    let cols, finalTicket, finalTickets = [], colPlaceholder = [];
    for (b = 0; b < tickets; b++) {
        cols = Array(9).fill(2);
        finalTicket = Array(3);
...
const sortNumbersinArray = (a, b) => {
    return a > b ? 1 : b > a ? -1 : 0;
}
const getUniqueRandomNumber = (min, max, count) => {
    let random = [];
...
export const generateTickets = generateTickets;